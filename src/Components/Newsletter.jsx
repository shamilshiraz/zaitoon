...
const onSubmitHandler=(e)=>{
  ...
  return (
<div className="sm:w-1/2 mt-3 mx-3 sm:mx-auto border mb-5 p-3 text-center">      <p className='text-2xl font-medium text-black-600 mb-5'>Subscribe now and get 20% off</p>
